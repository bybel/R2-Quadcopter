...
void loop() {
  ...
  if (inputARM > 1500) {
    ...
    if (motorFR < MOTOR_ZERO_LEVEL + 95) motorFR = MOTOR_ZERO_LEVEL + 95;
    if (motorFL < MOTOR_ZERO_LEVEL + 95) motorFL = MOTOR_ZERO_LEVEL + 95; //histoire que les moteurs tournent
    if (motorBL < MOTOR_ZERO_LEVEL + 95) motorBL = MOTOR_ZERO_LEVEL + 95; //quand meme quand on arme
    if (motorBR < MOTOR_ZERO_LEVEL + 95) motorBR = MOTOR_ZERO_LEVEL + 95;
